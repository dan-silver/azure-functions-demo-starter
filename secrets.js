"use strict";
exports.OpenWeatherMapAppId = process.env["OpenWeatherMapAppId"];
exports.MicrosoftAppSecret = process.env["MicrosoftAppSecret"];
exports.MicrosoftAppID = process.env["MicrosoftAppID"];
exports.MicrosoftAppRefreshToken = process.env["MicrosoftAppRefreshToken"];
exports.CheckWeatherAppKey = process.env["CheckWeatherAppKey"];
